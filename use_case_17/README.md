...
│   ├── agentic_flow.py                         # Runs the agentic flow for the initial memo creation
│   ├── agentic_flow_feedback.py                # Runs the agentic flow for the incorporation of feedback
...
│       └── critic_tool.py
│
├── agentic_flow_memo_feedback/                 # Agent‑specific code for the agentic module feedback integration tool
│   ├── __init__.py
...
│   │   ├── __init__.py
│   │   ├── planner_agent.py
│   │   ├── feedback_orchestrator_agent.py
│   │   ├── section_refiner_agent.py
│   │   └── critic_agent.py
│   │
│   └── tools/
│       └── __init__.py                         # re‑exports shared tools
│
